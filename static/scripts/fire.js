...
class Stage {
  ...
  onResize = function() {
    ...
    this.stage.position.y = window.innerHeight / 2;  // Center vertically
    this.flamesContainer.position.x = 0;  // Center horizontally within the stage
    this.flamesContainer.position.y = 0;  // Center vertically within the stage
  }
