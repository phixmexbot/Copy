...
PASSWORD = 'eternal'
REACTIONS = ['👍', '🔥', '❤️', '👏', '🕊']
DIRECTORIES = ['home', 'about', 'activities', 'services', 'projects', 'contact', 'activities/lightening-flash', 'activities/orbit-around', 'activities/doodle-rain', 'activities/angry-birds', 'services/chat-bot', 'services/home-tab', 'projects/automatic-attendance']
