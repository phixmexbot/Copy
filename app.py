...
PASSWORD = 'eternal'
REACTIONS = ['👍', '🔥', '❤️', '👏', '🕊']
DIRECTORIES = ['home', 'about', 'copyright', 'html/initial', 'happy-birthday', 'activities/lightening-flash', 'activities/orbit-around', 'activities/doodle-rain', 'activities/angry-birds', 'services/chat-bot', 'services/home-tab', 'projects/automatic-attendance', 'projects/ai-navigator']
